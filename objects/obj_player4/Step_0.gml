...
var key_fly = keyboard_check(ord("X"))
var key_shoot = keyboard_check(ord("Z"))
var key_shield_pressed = keyboard_check(vk_down)
var key_shield_release = keyboard_check_released(vk_down)
